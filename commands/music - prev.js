...
module.exports = class Hello extends DBF.Command{
    ...
    run(params = {msg, args}){
        ...
        msg.channel.send(`:track_next: Going back \`${msg.guild.playlist.queue.prev(incrementN)-1}\` tracks as requested by **${msg.member.displayName}**`).catch(err => console.log(err));
